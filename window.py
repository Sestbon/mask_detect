...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        ...
        self.model = self.model_load(weights="runs/train/exp3/weight/bests.pt",
    ...
    ***界面初始化***
    ...
    def initUI(self):
        ...
        self.right_img.setPixmap(QPixmap("images/UI/result.jpg"))
        ...
        up_img_button.setStyleSheet("QPushButton{background-color:black;"
                                    " color: white;"
                                    "border-radius: 10px;"
                                    ...
                                    "border-style: inset; }")
        det_img_button.setStyleSheet("QPushButton{background-color:black;"
                                    " color: white;"
                                    "border-radius: 10px;"
                                    "border: 2px groove gray;"
                                    "border-style: outset;}"
        ...
        self.webcam_detection_btn.setStyleSheet("QPushButton{background-color:black;"
                                    " color: white;"
                                    "border-radius: 10px;"
                                    "border: 2px groove gray;"
                                    "border-style: outset;}"
                                    ...
                                    "QPushButton:pressed{background-color:rgb(85, 170, 255);"
                                    "border-style: inset; }")
        self.mp4_detection_btn.setStyleSheet("QPushButton{background-color:black;"
                                    " color: white;"
                                    "border-radius: 10px;"
                                    "border: 2px groove gray;"
                                    "border-style: outset;}"
                                    ...
                                    "QPushButton:pressed{background-color:rgb(85, 170, 255);"
                                    "border-style: inset; }")
        self.vid_stop_btn.setStyleSheet("QPushButton{background-color:black;"
                                    " color: white;"
                                    "border-radius: 10px;"
                                    "border: 2px groove gray;"
                                    "border-style: outset;}"
        ...
        about_title = QLabel('\n我超勇的哦！！\n我都不戴口罩的')
        about_title.setFont(QFont('楷体', 30))
        about_title.setAlignment(Qt.AlignCenter)
        about_img = QLabel()
        about_img.setPixmap(QPixmap('images/tmp/single_result.jpg'))
        about_img.setAlignment(Qt.AlignCenter)

        # label4.setText("<a href='https://oi.wiki/wiki/学习率的调整'>如何调整学习率</a>")
        label_super = QLabel()
        label_super.setFont(QFont('楷体', 36))
